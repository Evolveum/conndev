 ...
 * link:https://github.com/Evolveum/connector-scimrest/[`scimrest-connector`] - **SCIMREST Framework**: SCIM 2 and REST connector library and framework (`connector-scimrest-common`) plus generic SCIM connector & sample connectors.
*  link:https://github.com/Evolveum/connector-scimrest/[`sql-connector`] - **SQL connector** library and framework (`connector-sql-base`) plus the generic SQL connector (PostgreSQL/Oracle drivers).
