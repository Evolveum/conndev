...
public record AttributeSupport(BaseAttributeDefinition attributeInfo, Collection<Object> values, Collection<Transition> transitions) {
    ...
    public static class Builder implements UpdateOperationBuilder.AttributeValueFilter {
        ...
        public AttributeSupport build(BaseAttributeDefinition attribute) {
