...
public class FilterBasedSearchDispatcher<HC> implements ObjectSearchOperation {
    ...
    private final ObjectSearchOperation anyFilterHandler;


    ObjectSearchOperation emptyFilterSupport;
    Set<FilterAwareExecuteQueryProcessor> implementations;

    public FilterBasedSearchDispatcher(ObjectSearchOperation emptyFilterHandler, ObjectSearchOperation anyFilterHandler, HashSet<FilterAwareExecuteQueryProcessor> handlers) {
    ...
    private ObjectSearchOperation findImplementation(Filter filter, OperationOptions operationOptions) {
